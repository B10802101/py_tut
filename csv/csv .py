...
# os.chdir('./csv')                                                            #change directory
# print(os.getcwd())                                                           #get current directory
# print(os.path.exists('./list.py'))                                           #check if a file exist
...
#     with open('example_copy.csv', 'w') as copy_file:                                            #copy_file is a variable of the file example_copy
